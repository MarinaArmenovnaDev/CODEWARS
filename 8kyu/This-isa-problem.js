// ❓Mы хотим создать функцию-конструктор 'NameMe', которая принимает имя и фамилию в качестве параметров. Функция объединяет имя и фамилию и сохраняет значение в свойстве "name".
